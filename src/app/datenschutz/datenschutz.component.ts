  ...
  template: `
    <div class="container mx-auto py-10 px-4 bg-gray-50 rounded-lg shadow-md">
      <div class="container py-5">
        ...
        <p>Gebr&uuml;der Ziegler GmbH &amp; Co. KG<br />
          Durmersheimer Str. 128<br />
          76189 Karlsruhe</p>
        ...
        dieser Website ist:</p> <p>Kartenkrieger<br />
        Seven Karcher<br />
        August-Bebel-Str. 69<br />
        76187 Karlsruhe</p>
        <p>Telefon: +49 176 47229853<br />
          E-Mail: sven.karcher&#64;kabelbw.de</p>
      ...
      <!-- Angular Material Button, der zur Startseite navigiert -->
      <div class="mt-8">
